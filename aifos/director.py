...
class Director:
    ...
    def _candidate_portrait_prompt(self, name, role, style, design, variant,
        ...
        return (
            ...
            + "【VARIATION】候选之间只比较同一画风下的人物身份、表情、轻微姿态"
            "和剧情造型细节；不得通过更换媒介、渲染、色彩系统、时代、世界观、"
            "镜头语言或项目风格制造差异；所有候选必须适配角色的性别表达、年龄、"
            "职业、物种、人物背景和当前剧情，不得套用现代都市默认模板"
            f"。【PROJECT STYLE LOCK】本项目唯一画风:{style}；所有候选必须完全一致；"
            f"{WORKWEAR_RULE}{CHARACTER_BACKGROUND_RULE}"
