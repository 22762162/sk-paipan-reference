...
GENRE_LOOKS = {
    ...
    "suspense": {
        ...
        "grammar": (
            ...
            "动势:惊变瞬间用甩镜,逼近真相用缓慢俯冲,认知崩塌的"
            "单一极点可限量用希区柯克变焦(实验级,预期不稳回退为推)"),
    ...
    "wuxia": {
        ...
        "grammar": (
            ...
            "对角线与低角度强化力量与对峙;动势:交锋决胜一击用升格,"
            "高潮从高处俯冲入局,追击与换阵用甩镜衔接"),
